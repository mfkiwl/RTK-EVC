...
We open-source the source code and experiment dataset of a novel Real-time Kinematic positioning architecture with Enhanced Velocity Constraints (RTK-EVC) via Factor Graph Optimization in GNSS-challenged Environments. The related paper has been accepted by IEEE Transactions on Vehicular Technology. If you use the contents of this repository in your work, please cite our paper as follows:
```
Q. Zhao, S. Yan, G. Liu, R. Zhang, S. Lü and J. Lou, "RTK-EVC: Real-Time Kinematic Positioning With Enhanced Velocity Constraints Via Factor Graph Optimization in GNSS-Challenged Environments," in IEEE Transactions on Vehicular Technology, doi: 10.1109/TVT.2025.3611095.
```
